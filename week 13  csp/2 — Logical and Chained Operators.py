...
password = input("What is your ssword?: ")
if len(password)>=12 and len(char.isdigit() for char in password)>=3:
    print("Password is valid.")
else:
    print("Password is invalid." \
    " It must contain at least 12 characters and at least three digits.")
